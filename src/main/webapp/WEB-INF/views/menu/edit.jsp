...
<h1>‖ 시스템메뉴 수정 ‖</h1><br><br>
	<div style="width: 60%">
		<form action="/menu/update" id="updateForm" method="post">
			...
			<table>
				<tbody>
					...
					<tr>
						<th>비고</th>
						<td><textarea class="noresize"name="menuCd" id="menuCd" placeholder="설명을 입력하세요"  ></textarea></td>
					</tr>
				</tbody>			
			</table>
			<div class="fr">
