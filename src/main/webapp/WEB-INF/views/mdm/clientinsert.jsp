...
// 	if($('#clntType').val() == "자사") {
// 		$('input[name=clntCode]').attr('value',"A");
// 	}
	
// 	if($('#clntType').val() == "협력사") {
// 			$('input[name=clntCode]').attr('value',"J");
// 		}
	
// 	if($('#clntType').val() == "고객사") {
// 			$('input[name=clntCode]').attr('value',"C");
// 		}
// });
...
<br>
<h2> 거래처 추가 </h2>
<form action="${pageContext.request.contextPath }/mdm/clientinsertPro" method="post" onsubmit="return check()" id="form">
<table>
	<tr><td class="i">거래처코드 <span class="star">*</span></td>  <td><input type="text" name="clntCode" class="clntCode" id="clntCode" maxlength="5" value="${clientDTO.clntCode}"></td></tr>
	<tr><td class="i">거래처명 <span class="star">*</span></td>  <td><input type="text" name="clntName" class="clntName" value="${clientDTO.clntName}"></td></tr>
	<tr><td class="i">거래처구분</td> <td><select name="clntType" id="clntType" onchange="clientCode(this);">
	...
	<tr><td class="i">담당자 <span class="star">*</span></td> <td><input type="text" name="manager" class="manager" value="${clientDTO.manager}"></td></tr>
	<tr><td class="i">우편번호</td> <td><input type="text" name="zipCode" value="${clientDTO.zipCode}" readonly>
