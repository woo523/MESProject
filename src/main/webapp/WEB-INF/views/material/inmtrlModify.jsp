...
<div class="content_body">
	<h2> 자재 입고 수정 </h2>
	<br>
	<form action="${pageContext.request.contextPath}/material/inmtrlModifyPro" method="post" onsubmit="return checkForm()">
		<input type="hidden" name="inmtrlId" value="${materialDTO.inmtrlId}">
			<ul>
				...
				<li> 입고번호 <input type="text"  value="${inmaterialDTO.inmtrlNum}" readonly></li>
				...
				<li> 단위 <input type="text" name="unit" value="${itemDTO.invntUnit}"></li>
