...
<!-- 10페이지 이전 -->
	...
	<a href="${pageContext.request.contextPath }/material/itemList?itemNum=${search.itemNum}&itemName=${search.itemName}&pageNum=${pageDTO.startPage-PageDTO.pageBlock}">[10페이지 이전]</a>
	</c:if>
	
	<c:forEach var="i" begin="${pageDTO.startPage }" end="${pageDTO.endPage }" step="1">
	<a href="${pageContext.request.contextPath }/material/itemList?itemNum=${search.itemNum}&itemName=${search.itemName}&pageNum=${i}">${i}</a> 
	</c:forEach>
